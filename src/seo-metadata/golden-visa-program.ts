export const goldenVisaProgramMetadata = {
  en: {
    title:
  ...
  fr: {
    ...
    keywords: [
      ...
      "éligibilité visa gold portugais",
  ...
  de: {
    ...
    keywords: [
      ...
      "portugiesisches golden visa berechtigung",
  ...
  pt: {
    ...
    keywords: [
      ...
      "elegibilidade visto gold português",
  ...
  nl: {
    ...
    keywords: [
      ...
      "portugees golden visa geschiktheid",
  ...
  ru: {
    title:
      "Программа Золотой Визы Португалии - Полное Руководство по Инвестициям и Резидентству",
    description:
      "Полное руководство по программе Золотой Визы Португалии. Узнайте о требованиях к инвестициям, критериях отбора, разрешениях на проживание и путях к гражданству через инвестиции в недвижимость в Алгарве. Экспертная помощь для получения португальского резидентства.",
    keywords: [
      "золотая виза португалия",
      "программа золотая виза португалия",
      "разрешение на жительство инвестиции португалия",
      "золотая виза алгарве",
      "инвестиционная виза португалия",
      "требования золотая виза португалия",
      "гражданство португалии через инвестиции",
      "право на золотую визу португалии",
      "виза на проживание португалия",
      "золотая виза инвестиции недвижимость",
      "постоянное проживание португалия",
      "резидентство инвестиции алгарве",
      "виза инвестора португалия",
      "заявка золотая виза португалия",
      "резидентство через инвестиции португалия",
      "шенгенская виза португалия",
      "золотая виза португалия 2024",
      "инвестировать резидентство португалия",
      "португальское гражданство инвестиции",
      "недвижимость алгарве золотая виза",
    ],
    ogTitle:
      "Программа Золотой Визы Португалии - Резидентство через Инвестиции в Алгарве",
    classification:
      "Информация о золотой визе, Инвестиционная виза Португалия, Руководство разрешение на жительство, Гражданство через инвестиции",
    category:
      "Руководство по иммиграции, Инвестиционная виза, Программа резидентства, Путь к гражданству, Юридические требования, Виза инвестиций в недвижимость",
    dcTitle:
      "Руководство программа золотая виза Португалия, Резидентство инвестиции Алгарве, Португальское гражданство через инвестиции, Разрешение на жительство золотой треугольник",
    audience:
      "Международные инвесторы, Покупатели недвижимости, Соискатели резидентства, Граждане не из ЕС",
    articleSection: "Иммиграция и Инвестиции",
  },
  se: {
    title:
    ...
    keywords: [
      ...
      "portugisiskt golden visa behörighet",
...
export type GoldenVisaProgramLocale = keyof typeof goldenVisaProgramMetadata;
