export const termsAndConditionsMetadata = {
  en: {
    title: "Terms and Conditions - Privacy Policy & Legal Information",
    description:
      "Terms and Conditions, Privacy Policy, and legal information for Buy Property Portugal. Learn about our data collection, security practices, cookies policy, and your rights regarding personal information when using our luxury property services.",
    ogTitle: "Terms and Conditions - Privacy Policy | Buy Property Portugal",
    ogDescription:
  ...
  fr: {
    title:
      "Conditions Générales - Politique de Confidentialité & Informations Légales",
    description:
      "Conditions Générales, Politique de Confidentialité et informations légales pour Buy Property Portugal. Découvrez nos pratiques de collecte de données, de sécurité, notre politique de cookies et vos droits concernant les informations personnelles lors de l'utilisation de nos services immobiliers de luxe.",
    ogTitle:
      "Conditions Générales - Politique de Confidentialité | Buy Property Portugal",
    ogDescription:
    ...
    keywords: [
      ...
      "droits utilisateur protection données",
    ],
    classification:
      "Conditions légales, Politique confidentialité, Conditions service, Politique protection données",
    category:
  ...
  de: {
    ...
    description:
      "Allgemeine Geschäftsbedingungen, Datenschutzerklärung und rechtliche Informationen für Buy Property Portugal. Erfahren Sie mehr über unsere Datenerfassung, Sicherheitspraktiken, Cookie-Richtlinien und Ihre Rechte bezüglich persönlicher Informationen bei der Nutzung unserer Luxusimmobilienservices.",
    ogTitle: "AGB - Datenschutzerklärung | Buy Property Portugal",
    ogDescription:
    ...
    classification:
      "Rechtliche Bedingungen, Datenschutzerklärung, Nutzungsbedingungen, Datenschutzrichtlinie",
    category:
  ...
  pt: {
    ...
    description:
      "Termos e Condições, Política de Privacidade e informação legal para Buy Property Portugal. Saiba mais sobre a nossa recolha de dados, práticas de segurança, política de cookies e os seus direitos relativos a informações pessoais ao utilizar os nossos serviços de propriedades de luxo.",
    ogTitle:
      "Termos e Condições - Política de Privacidade | Buy Property Portugal",
    ogDescription:
    ...
    keywords: [
      ...
      "direitos utilizador proteção dados",
    ],
    classification:
      "Termos legais, Política privacidade, Termos serviço, Política proteção dados",
    category:
  ...
  nl: {
    ...
    description:
      "Algemene Voorwaarden, Privacybeleid en juridische informatie voor Buy Property Portugal. Leer over onze gegevensverzameling, beveiligingspraktijken, cookiebeleid en uw rechten met betrekking tot persoonlijke informatie bij het gebruik van onze luxe vastgoedservices.",
    ogTitle: "Algemene Voorwaarden - Privacybeleid | Buy Property Portugal",
    ogDescription:
    ...
    keywords: [
      ...
      "gebruikersrechten gegevensbescherming",
    ],
    classification:
      "Juridische voorwaarden, Privacybeleid, Servicevoorwaarden, Gegevensbeschermingsbeleid",
    category:
  ...
  ru: {
    title:
      "Условия и Положения - Политика Конфиденциальности & Юридическая Информация",
    description:
      "Условия и Положения, Политика Конфиденциальности и юридическая информация для Buy Property Portugal. Узнайте о нашем сборе данных, практиках безопасности, политике использования файлов cookie и ваших правах в отношении личной информации при использовании наших услуг элитной недвижимости.",
    ogTitle:
      "Условия и Положения - Политика Конфиденциальности | Buy Property Portugal",
    ogDescription:
    ...
    keywords: [
      ...
      "права пользователя защита данных",
    ],
    classification:
      "Юридические условия, Политика конфиденциальности, Условия обслуживания, Политика защиты данных",
    category:
      "Юридическая документация, Уведомление конфиденциальности, Условия положения, Пользовательское соглашение, Защита данных, Политика cookies",
    dcTitle:
      "Условия положения Buy Property Portugal, Политика конфиденциальности элитная недвижимость Португалия, Юридические условия услуги недвижимость Алгарве",
  },
  sv: {
    title: "Villkor - Integritetspolicy & Juridisk Information",
    description:
      "Villkor, Integritetspolicy och juridisk information för Buy Property Portugal. Lär dig om vår datainsamling, säkerhetsrutiner, cookiepolicy och dina rättigheter gällande personlig information när du använder våra lyxfastighetstjänster.",
    ogTitle: "Villkor - Integritetspolicy | Buy Property Portugal",
    ogDescription:
    ...
    keywords: [
      ...
      "användarrättigheter dataskydd",
    ],
    classification:
      "Juridiska villkor, Integritetspolicy, Tjänstevillkor, Dataskyddspolicy",
    category:
...
export type SupportedLocale = keyof typeof termsAndConditionsMetadata;
